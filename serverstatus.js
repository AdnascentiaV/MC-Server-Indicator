function serverstatus(index, ip, port) {
    ...
    //   }
      ...
      document.querySelector('.server-status-' + index + ' .online').src = status.online ? 'images/up.png' : 'images/down.png';
      document.querySelector('.server-status-' + index + ' .favicon').src = status.online ? status.favicon : 'images/favicon_default.png';
      if (status.favicon == undefined)
      {
        document.querySelector('.server-status-' + index + ' .favicon').src = 'images/favicon_default.png';
      }
